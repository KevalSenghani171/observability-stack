...
# kubectl -n devops-tools cp dashboards/OBS ${grafana_pod}:/var/lib/grafana/dashboards/ -c grafana
# curl -uadmin:Admin@123 -H -s -X POST "http://localhost:3000/api/admin/provisioning/dashboards/reload"
